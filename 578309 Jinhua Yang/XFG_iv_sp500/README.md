...
Description: 'Uses principal component analysis method to analyze different types of implied volatility 
expectation index of S&P500 (including VXST(9-day), VIX(30-day), VXV(3-month), VXMT(6-month)) in year 
2011 to 2015, computes the variance and cumulated variance explained by principal components, compares 
the factor loadings of first and second principal components and price projected to PCs through year 
2011 to 2015.'
